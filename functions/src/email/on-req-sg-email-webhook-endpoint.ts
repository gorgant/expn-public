...
const isValidSgWebhookRequest = (req: Request, res: Response<any>): boolean => {
  ...
  const webhookKey = currentEnvironmentType === EnvironmentTypes.SANDBOX ? SgWebhookSignatureVerificationKeys.EXPN_SANDBOX_KEY : SgWebhookSignatureVerificationKeys.EXPN_PRODUCTION_KEY;
